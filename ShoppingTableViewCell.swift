...
class ShoppingTableViewCell: UITableViewCell {
  ...
  @IBOutlet weak var imageBackgroundShopping: UIImageView! // Фоновое изображение ячейки
  
  @IBOutlet weak var nameShoppingLabel: UILabel! // Название продукта в списке покупок
